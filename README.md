...
### Testing
1. Normally copy output folder after build success ex. vfte012 into [vueserve](https://github.com/willsofts/vueserve) project under public path and then you can launch it directly ex. 

    http://localhost:8080/vfte012/vfte012.html
